 ...
 */
export function dateFromExcelSerial(serial: number): number {
...
export function dateToExcelSerial(date: number): number {
  const utcDays = date / 86400000; // get the number of days since 1/1/1970 by dividing the number by daily milliseconds
