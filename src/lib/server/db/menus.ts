export const new_Wards = [
  { name: 'ثالث أ', floor: 3, id: 5 },
  { name: 'ثالث ب', floor: 3, id: 6 },
  { name: 'ثالث ج', floor: 3, id: 7 },
  { name: 'ثالث د', floor: 3, id: 8 },
  { name: 'ثاني أ', floor: 2, id: 11 },
  { name: 'ثاني ب', floor: 2, id: 12 },
  { name: 'ثاني ج', floor: 2, id: 3 },
  { name: 'ثاني د', floor: 2, id: 4 },
  { name: 'رابع أ', floor: 4, id: 9 },
  { name: 'رابع ب', floor: 4, id: 10 },
